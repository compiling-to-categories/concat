...
effectVerilog :: GenBuses a => (a :> b) -> String
effectVerilog circ = unlines $
  [ "/***"
  ...
  , "***/"
  -- , ppModule $ mk_module (verilog circ)
  , ""
  , "module top ();"
  , "    initial begin"
  , "        $display(\"Hello, World! I am an empty soulless Verilog module. Please, give my existence meaning.\");"
  , "    end"
  , "endmodule"
  ]
...
genVerilog :: GenBuses a => String -> (a :> b) -> IO ()
genVerilog name circ =
  do createDirectoryIfMissing False outDir
     let o = outFile name
     writeFile o (effectVerilog circ)
     putStrLn ("Wrote " ++ o)
...
-- verilog :: GenBuses a => (a :> b) -> Module
-- verilog = compsShader widgets
--              . fmap simpleComp
--              . mkGraph
-- 
